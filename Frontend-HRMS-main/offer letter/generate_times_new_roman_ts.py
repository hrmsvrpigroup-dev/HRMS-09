...
with open(r'c:\Users\shiva\OneDrive\Desktop\hrms-lastest\Frontend-HRMS-main\offer letter\sig_b64.txt', 'r') as f:
        ...
        return """
          ...
          <div class="signature-container">
            <div class="sig-box">
              ...
              <img src="${VRPI_SIGNATURE_DATA_URI}" class="sig-image" alt="Signature" />
...
"""
        ...
        return """
          ...
          <p class="body-paragraph" style="margin-bottom: 10px; font-size: 13.5px; color: #000000;">
            ...
            <table class="salary-table">
              <tbody>
                ...
                <tr class="table-row-lightgreen-gross">
                  ...
                  <td style="text-align: right;"><strong>${b.monthlyGross.toLocaleString('en-IN')}</strong></td>
                  <td style="text-align: right;"><strong>${b.annualCtc.toLocaleString('en-IN')}</strong></td>
                </tr>
                ...
                <tr class="table-row-net-takehome">
                  <td><strong>Net Take-Home Salary (In-Hand)</strong></td>
                  <td style="text-align: right;"><strong>₹${b.netMonthly.toLocaleString('en-IN')}</strong></td>
                  <td style="text-align: right;"><strong>₹${b.netYearly.toLocaleString('en-IN')}</strong></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="signature-container">
            <div class="sig-box">
              <strong>For VR PI TECH SOLUTIONS LLP</strong><br />
              <img src="${VRPI_SIGNATURE_DATA_URI}" class="sig-image" alt="Signature" />
              <div class="sig-line">________________________</div>
              <strong>Authorized Signatory &amp; Seal</strong>
            </div>
...
ts_lines = [
    ...
    "// VR PI TECH SOLUTIONS LLP (Times New Roman, Exact DOCX Typography & Watermark)",
    "// ═══════════════════════════════════════════════════════════════════════════════",
    "",
    f"export const VRPI_WATERMARK_DATA_URI = '{watermark_b64}';",
    f"export const VRPI_LOGO_DATA_URI = '{logo_b64}';",
    f"export const VRPI_SIGNATURE_DATA_URI = '{sig_b64}';",
...
ts_lines.extend([
    ...
    "    body { font-family: 'Times New Roman', Times, Georgia, serif !important; color: #000000; background: #cbd5e1; font-size: 13.5px; line-height: 1.5; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }",
    "    .offer-doc-container { display: flex; flex-direction: column; align-items: center; gap: 24px; padding: 24px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .page-sheet { width: 210mm; min-height: 297mm; padding: 18mm 20mm 18mm 20mm; background: #ffffff; box-shadow: 0 4px 20px rgba(0,0,0,0.12); border-radius: 2px; position: relative; display: flex; flex-direction: column; justify-content: space-between; page-break-after: always; overflow: hidden; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    ...
    "    .page-content-wrapper { position: relative; z-index: 1; flex: 1; display: flex; flex-direction: column; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .letterhead-header { display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 2.5px solid #1e3a8a; padding-bottom: 10px; margin-bottom: 16px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .letterhead-header-small { display: flex; justify-content: space-between; align-items: center; border-bottom: 1.5px solid #94a3b8; padding-bottom: 5px; margin-bottom: 14px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .company-name { font-size: 19px; font-weight: bold; color: #1e3a8a; letter-spacing: 0.5px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .company-name-small { font-size: 13.5px; font-weight: bold; color: #1e3a8a; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .company-sub { font-size: 10px; color: #475569; margin-top: 3px; line-height: 1.35; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .company-logo { height: 44px; width: auto; object-fit: contain; }",
    "    .company-logo-small { height: 26px; width: auto; object-fit: contain; }",
    "    .meta-row { display: flex; justify-content: space-between; font-weight: bold; margin-bottom: 12px; font-size: 13.5px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .cand-salutation { margin: 8px 0 12px 0; font-size: 14px; font-weight: bold; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    ...
    "    .small-muted { font-size: 11.5px; color: #475569; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .table-card { border: 1.5px solid #000000; overflow: hidden; margin: 6px 0; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .salary-table { width: 100%; border-collapse: collapse; font-size: 11px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .salary-table td, .salary-table th { border: 1px solid #000000; padding: 3px 6px; font-size: 11px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .table-row-green-header { background-color: #00AF50 !important; font-weight: bold; text-align: center; text-transform: uppercase; font-size: 12px; color: #ffffff !important; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .table-row-green-header td { color: #ffffff !important; font-weight: bold; text-align: center; padding: 4px 6px; }",
    "    .table-row-yellow-sub { background-color: #FFFF00 !important; font-weight: bold; color: #000000 !important; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .table-row-yellow-sub td { font-weight: bold; color: #000000 !important; }",
    "    .table-row-lightgreen-gross { background-color: #92D050 !important; font-weight: bold; color: #000000 !important; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .table-row-lightgreen-gross td { font-weight: bold; color: #000000 !important; }",
    "    .table-row-white { background-color: #ffffff !important; color: #000000 !important; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .table-row-net-takehome { background-color: #ecfdf5 !important; font-weight: bold; color: #065f46 !important; font-size: 11.5px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .annexure-title { text-align: center; font-weight: bold; text-decoration: underline; font-size: 15px; margin: 4px 0 2px 0; color: #000000; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .acceptance-box { margin: 6px 0; font-size: 10.5px; border: 1.5px solid #000000; padding: 5px 8px; background: #ffffff; line-height: 1.35; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .signature-container { display: flex; justify-content: space-between; margin-top: 6px; margin-bottom: 4px; font-size: 11.5px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .sig-box { width: 45%; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .sig-image { height: 30px; width: auto; display: block; margin: 2px 0; }",
    "    .sig-seal { height: 34px; width: auto; display: block; margin-bottom: 2px; }",
    "    .sig-line { margin: 6px 0 2px 0; }",
    "    .page-footer-bar { position: relative; z-index: 1; display: flex; justify-content: space-between; border-top: 1px solid #cbd5e1; padding-top: 4px; font-size: 10px; color: #64748b; margin-top: 6px; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .footer-addresses { display: flex; justify-content: space-between; gap: 8px; border-top: 1px solid #000000; padding-top: 4px; margin-top: 6px; font-size: 8.5px; line-height: 1.3; color: #475569; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    .office-col { flex: 1; line-height: 1.3; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "    @media print {",
    "      body { background: #ffffff !important; padding: 0 !important; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "      .offer-doc-container { padding: 0 !important; gap: 0 !important; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
    "      .page-sheet { width: 100% !important; min-height: 100vh !important; height: 100vh !important; box-shadow: none !important; border-radius: 0 !important; padding: 15mm 15mm 15mm 15mm !important; margin: 0 !important; page-break-after: always !important; font-family: 'Times New Roman', Times, Georgia, serif !important; }",
...
print(f"Successfully generated {ts_file_path} with exact Times New Roman typography!")
