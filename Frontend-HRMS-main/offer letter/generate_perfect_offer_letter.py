...
"""
        ...
        return """
          ...
          <p class="body-paragraph" style="margin-bottom: 10px; font-size: 0.85rem; color: #1e293b;">
          ...
          <div class="signature-container" style="margin-top: 14px; margin-bottom: 8px;">
            <div class="sig-box">
              <strong>For VR PI TECH SOLUTIONS LLP</strong><br /><br />
              <img src="${VRPI_SIGNATURE_DATA_URI}" class="sig-image" alt="Signature" />
              <div class="sig-line">________________________</div>
            ...
            <div class="sig-box">
              <strong>Candidate Signature:</strong><br /><br /><br /><br />
              <div class="sig-line">________________________</div>
              <strong>Name: ${d.candidateName}</strong><br />
              <span>Date: ___________________</span>
            </div>
...
ts_lines.extend([
    ...
    "    .salary-table td, .salary-table th { border: 1px solid #000000; padding: 6px 10px; font-size: 12px; }",
    ...
    "    .table-row-green-header td { color: #ffffff !important; font-weight: 800; text-align: center; padding: 7px 10px; }",
    ...
    "    .acceptance-box { margin: 14px 0 12px 0; font-size: 11.5px; border: 1.5px solid #000000; padding: 8px 10px; background: #ffffff; line-height: 1.45; }",
    "    .signature-container { display: flex; justify-content: space-between; margin-top: 18px; font-size: 12px; }",
    "    .sig-box { width: 45%; }",
    "    .sig-image { height: 38px; width: auto; display: block; margin: 4px 0; }",
    "    .sig-seal { height: 42px; width: auto; display: block; margin-bottom: 4px; }",
    "    .sig-line { margin: 10px 0 3px 0; }",
    ...
    "    .footer-addresses { display: flex; justify-content: space-between; gap: 8px; border-top: 1px solid #000000; padding-top: 6px; margin-top: 14px; font-size: 9px; color: #475569; }",
...
print(f"Successfully generated {ts_file_path} with zero comment artifacts and signature!")
