...
ts_lines = [
    ...
    "// VR PI TECH SOLUTIONS LLP (Exact DOCX layout, Watermark & Annexure Table)",
    "// ═══════════════════════════════════════════════════════════════════════════════",
    "",
...
ts_lines.extend([
    ...
    "    body { font-family: 'Calibri', 'Arial', sans-serif; color: #000000; background: #e2e8f0; font-size: 13px; line-height: 1.5; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }",
    ...
    "    .watermark-bg { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 68%; max-width: 480px; opacity: 0.085; pointer-events: none; z-index: 0; object-fit: contain; }",
    ...
    "      .watermark-bg { opacity: 0.085 !important; }",
    ...
    "        <img src=\"/image1.png\" class=\"watermark-bg\" alt=\"VR PI Watermark\" onerror=\"this.src='/watermark_bg.png'\" />",
...
print(f"Successfully updated {ts_file_path} with watermark & exact docx table colors!")
